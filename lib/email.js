...
class EmailService {
  ...
  async sendNewListingsNotification(
    userEmail,
    jobData,
    newListingsCount,
    spreadsheetUrl
    ...
    try {
      ...
      const subject = `🏠 New Property Listings Found - ${newListingsCount} new results`;
      ...
      const htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #ecf0f1; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <p><strong>Spreadsheet:</strong> <a href="${spreadsheetUrl}" style="color: #3498db;">View Results</a></p>
          </div>
